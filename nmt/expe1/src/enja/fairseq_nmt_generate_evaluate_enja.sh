...
for dataset in aspec bsd duo iwslt jesc kftt ttb; do
    ...
    MODEL_DIR=/home/ubuntu/Laboro-ParaCorpus/nmt/expe1/model/laboro_base_${SRC}${TRG}
    RESULT_DIR=/home/ubuntu/Laboro-ParaCorpus/nmt/expe1/results/${SRC}${TRG}/test_${dataset}_base
    mkdir -p $RESULT_DIR
