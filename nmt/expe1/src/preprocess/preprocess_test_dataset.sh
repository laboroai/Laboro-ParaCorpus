...
for dataset in aspec bsd duo iwslt jesc kftt ttb; do
    ...
    ORIG_CORPUSDIR=/home/ubuntu/nmt/expe14/corpus/${dataset}
    SPM_CORPUSDIR=/home/ubuntu/nmt/expe14/corpus/${dataset}_test_spm
    ...
    python3 /home/ubuntu/nmt/expe14/src/preprocess/len_filter.py $SPM_CORPUSDIR test
